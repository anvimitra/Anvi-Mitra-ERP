...
-- This prevents an unauthorized teacher from using offline sync as a way around
-- the normal teacher + subject + class/section authorization rule.
...
FOR EACH ROW
EXECUTE FUNCTION guard_sync_teacher_exam_marks();
