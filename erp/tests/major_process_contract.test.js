...
for (const token of ["app.post('/api/platform/schools'", 'school_settings', 'mobile_app_configs', 'branches', 'await hashPassword(adminPassword)']) assert(org.includes(token), 'School provisioning contract missing: '+token);
