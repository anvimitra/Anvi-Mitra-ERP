...
for(const file of ['src/timetable.js','sql/033_timetable.sql','web/timetable.html']){if(!fs.existsSync(path.join(root,file)))throw new Error('Missing timetable implementation: '+file)}
