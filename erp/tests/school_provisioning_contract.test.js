...
assert(organization.includes("password_hash,role,status) VALUES($1,$2,$3,$4,$5,$6,'active')"), 'Administrator role/status provisioning contract missing');
assert(organization.includes("adminRole"), 'Administrator role selection is missing');
