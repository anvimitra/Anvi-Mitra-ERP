...
app.get('/', (_req,res) => res.sendFile(path.join(__dirname,'../web/super_admin_schools.html')));
app.get('/super-admin/schools', (_req,res) => res.sendFile(path.join(__dirname,'../web/super_admin_schools.html')));
