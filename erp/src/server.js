...
if (pool) {
  ...
  const modules = [
    ['sync_routes','registerSyncRoutes'], ['local_storage','registerLocalStorageRoutes'], ['organization','registerOrganizationRoutes'], ['platform_school_management','registerPlatformSchoolManagementRoutes'], ['platform_compat','registerPlatformCompatRoutes'],
    ['routes','registerRoutes'], ['people','registerPeopleRoutes'], ['staff','registerStaffRoutes'], ['attendance','registerAttendanceRoutes'], ['staff_attendance','registerStaffAttendanceRoutes'], ['attendance_reports','registerAttendanceReportRoutes'], ['exams','registerExamRoutes'], ['exam_scheduling','registerExamSchedulingRoutes'], ['exam_results','registerExamResultRoutes'], ['exam_marks','registerExamMarkRoutes'],
    ['fees','registerFeeRoutes'], ['fee_ledger','registerFeeLedgerRoutes'], ['fee_assignments','registerFeeAssignmentRoutes'], ['fee_receipts','registerFeeReceiptRoutes'], ['payments','registerPaymentRoutes'], ['notifications','registerNotificationRoutes'], ['notification_automation','registerNotificationAutomationRoutes'], ['integration_seams','registerIntegrationSeamRoutes'],
    ['reportcard_engine_route','registerReportCardEngineRoute'], ['reportcard_result_sync','registerReportCardResultSyncRoutes'], ['reportcards','registerReportCardRoutes'], ['reportcard_context','registerReportCardContextRoutes'], ['reportcard_list','registerReportCardListRoutes'], ['reportcard_bulk','registerReportCardBulkRoutes'],
    ['academics','registerAcademicRoutes'], ['timetable','registerTimetableRoutes'], ['academic_master','registerAcademicMasterRoutes'], ['academic_progress','registerAcademicProgressRoutes'], ['analytics','registerAnalyticsRoutes'], ['report_exports','registerReportExportRoutes'],
    ['admissions','registerAdmissionRoutes'], ['portal','registerPortalRoutes'], ['student_crud','registerStudentCrudRoutes'], ['student_enrollment','registerStudentEnrollmentRoutes'], ['student_promotion','registerStudentPromotionRoutes'], ['enrollment','registerEnrollmentRoutes'], ['teacher_assignments','registerTeacherAssignmentRoutes'], ['school_summary','registerSchoolSummaryRoutes'], ['mobile','registerMobileRoutes'], ['mobile_dashboards','registerMobileDashboardRoutes'], ['transport','registerTransportRoutes'], ['sync_admin','registerSyncAdminRoutes'], ['sync_conflict_resolution','registerSyncConflictResolutionRoutes'], ['teacher_permissions','registerTeacherPermissionRoutes']
  ];
