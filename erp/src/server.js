...
const { registerTeacherAttendanceRoutes } = require('./attendance_teacher');
...
const { securityHeaders, requestId } = require('./security_hardening');
const app = express();
